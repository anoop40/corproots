...
class cameraFileForAlertBox extends StatefulWidget {
  final CameraDescription camera;
  final uploadDocumentType;
  final returnUrl;

  const cameraFileForAlertBox({
    required Key key,
...
class TakePictureScreenState extends State<cameraFileForAlertBox> {
                ...
                try {
                  ...
                  if (widget.returnUrl == "electricityUtilityBill") {
                    ...
                    return Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            electricityUtilityBill(image.path),
                      ),
                    );
